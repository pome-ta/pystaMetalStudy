...
from .structures import Float4, Columns, Float16, M16, MatrixFloat3x3, Float3
...
class MatrixFloat4x4(ctypes.Union):
  ...
  def upperLeft3x3(self):
    x = Float3(self.c0.x, self.c0.y, self.c0.z)
    y = Float3(self.c1.x, self.c1.y, self.c1.z)
    z = Float3(self.c2.x, self.c2.y, self.c2.z)
    return MatrixFloat3x3(x, y, z)
