...
class Renderer:
  ...
  def _init(self, mtkView: MTKView) -> 'MTKViewDelegate':
    ...
    pdbg.state(MDLMesh.alloc())
    #newEllipsoidWithRadii_radialSegments_verticalSegments_geometryType_inwardNormals_hemisphere_allocator_
    
    '''

    mdlMesh = MDLMesh.newEllipsoidWithRadii_radialSegments_verticalSegments_geometryType_inwardNormals_hemisphere_allocator_(
      extent.ctypes, 100, 100, 2, False, False, self.allocator)
    '''
